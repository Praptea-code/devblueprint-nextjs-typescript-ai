...
function ReflectBackgroundBase(props: ReflectBackgroundProps) {
    const {
        tint = "#005980",
    ...
    useEffect(() => {
        ...
        // Props are static (baked-in preset, never updated at runtime), so the
        // WebGL shader only needs setting up once on mount.
...
export default function ReflectBackground(props: Record<string, unknown>) {
  return <ReflectBackgroundBase {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
